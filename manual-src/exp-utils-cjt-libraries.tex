...
\label{sect-samples}
%
\input{eucjt-libs-sample-synchbox}
...
\input{eucjt-libs-chris-notes}
\input{eucjt-libs-chris}
\input{eucjt-libs-ft-notes}
\input{eucjt-libs-ft}
\input{eucjt-libs-highlevel-notes}
\input{eucjt-libs-highlevel}
\input{eucjt-libs-meta-notes}
\input{eucjt-libs-meta}
\input{eucjt-libs-plot}
\input{eucjt-libs-tools}
\input{eucjt-libs-use-notes}
\input{eucjt-libs-use}
\input{eucjt-libs-util-notes}
