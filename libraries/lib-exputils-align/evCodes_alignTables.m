function [ newfirsttab, newsecondtab, ...
  ...
  evCodes_alignTables( firsttab, secondtab, ...
...
string(datetime), thiswinrad ));
  ...
  firstdeltas = firstdeltas + evCodes_interpolateSeries( ...
...
string(datetime), finewindow ));
  ...
  [ bestdeltalist bestcostlist ] = evCodes_alignWithFixedMapping( ...
    firsttimesaligned, secondtimes, firstdata, seconddata, ...
...
fitresidue = evCodes_squashOutliers( firsttimes, fitresidue, ...
...
firstdeltas = ...
  evCodes_interpolateSeries( sparsetimes, sparsedeltas, firsttimes );
...
seconddeltas = evCodes_interpolateSeries( ...
...
[ firstmatches secondmatches ] = evCodes_findMatchingEvents( ...
